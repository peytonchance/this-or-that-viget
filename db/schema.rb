...
ActiveRecord::Schema.define(version: 2018_08_01_203005) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["user_id", "poll_id"], name: "index_comments_on_user_id_and_poll_id"
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["poll_id"], name: "index_follows_on_poll_id"
    t.index ["user_id", "poll_id"], name: "index_follows_on_user_id_and_poll_id", unique: true
